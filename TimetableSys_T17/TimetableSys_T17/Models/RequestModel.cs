...
namespace TimetableSys_T17.Models
{
...

    {
        ...
        public int[] period { get; set; } // At back end, the lists will be unpacked and submitted approriately
        ...
        //public Nullable<int> adhoc { get; set; } :- Can determine this within the controller -- removed round from model.
